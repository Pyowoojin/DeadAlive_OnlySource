...
enum class ECombatState : uint8
{
	...
	ECS_Dead UMETA(DisplayNmae = "Dead"),
...
public:
	...
	FORCEINLINE UCameraComponent* GetCameraComponent() { return MainCam; };
...
private:
	...
	void Dead();
	void PlayAnimation(UAnimMontage* MontageName);
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	float MaxNoiseRange = 800.f;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Custom", meta = (AllowPrivateAccess = "true"))
	USoundBase* HitSound;

	// Related EquipmentComponent
	UPROPERTY(VisibleAnywhere)
